    ...
    <>
      ...
      >
        ...
        <div className="relative z-40 p-8">
          <motion.p className="text-left font-sans text-sm font-bold text-white md:text-base">
            {card.category}
          </motion.p>
          <motion.p className="mt-2 max-w-xs text-left font-sans text-sm text-white md:text-1xl">
            {card.title}
          </motion.p>
        </div>
        <BlurImage
